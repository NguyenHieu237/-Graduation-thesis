package com.apero.realistic.widget.rangeseekbar
...
class RangeSeekBar @JvmOverloads constructor(
    ...
    @ColorInt
    var unActiveLeftBarColor = Color.RED
        set(value){
            field = value
            invalidate()
        }
    @ColorInt
    var unActiveRightBarColor = Color.RED
        set(value){
            field = value
            invalidate()
        }
    ...
    private var textFont = ResourcesCompat.getFont(getContext(), R.font.rebond_bold)
    ...
    private fun init() {
        context.resources.apply {
            BitmapUtil.apply {
                thumbImage = toBitmap(getDrawable(R.drawable.ic_slider))
                thumbPressedImage = toBitmap(getDrawable(R.drawable.ic_slider))
//                thumbDisabledImage = toBitmap(getDrawable(R.drawable.ic_slider))
            }
        }
        ...
        attrs?.let {
            context.obtainStyledAttributes(it, R.styleable.RangeSeekBar).apply {
                ...
                unActiveLeftBarColor = getColor(R.styleable.RangeSeekBar_unActiveLeftBarColor, unActiveLeftBarColor)
                unActiveRightBarColor = getColor(R.styleable.RangeSeekBar_unActiveRightBarColor, unActiveRightBarColor)
            ...
            event?.let { event ->
                ...
                when (event.action and MotionEvent.ACTION_MASK) {
                    MotionEvent.ACTION_DOWN -> {
                        ...
                        if (pressedThumb != Thumb.MAX) return super.onTouchEvent(event)
        ...
        canvas?.apply {
            ...
            if (isGradientNeed) {
                paint.shader = LinearGradient(
                        ...
                        0f,
                        intArrayOf(unActiveLeftBarColor, unActiveRightBarColor),
                        floatArrayOf(0f, 1f),
...
//            }
            ...
            if (isGradientNeed) {
                paint.shader = LinearGradient(
                        ...
                        rectF.right,
                        0f,
                        intArrayOf(transitionBarColor, centerBarColor),
                        floatArrayOf(0f, 1f),
                        Shader.TileMode.REPEAT)
            } else {
...
//                        paint)
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        ) 0 else PixelUtil.dpToPx(context, thumbTextMargin) + PixelUtil.dpToPx(context, textSize) / 2
        ...
        ) 0 else PixelUtil.dpToPx(context, additionalTextMargin) + PixelUtil.dpToPx(context, textSize) / 2
    ...
    override fun onSaveInstanceState(): Parcelable? {
        ...
        bundle.putInt("UN_ACTIVE_LEFT_BAR_COLOR", unActiveLeftBarColor)
        bundle.putInt("UN_ACTIVE_RIGHT_BAR_COLOR", unActiveRightBarColor)
        return bundle
    }
    ...
    override fun onRestoreInstanceState(parcel: Parcelable) {
        ...
        unActiveLeftBarColor = bundle.getInt("UN_ACTIVE_LEFT_BAR_COLOR")
        unActiveRightBarColor = bundle.getInt("UN_ACTIVE_RIGHT_BAR_COLOR")
        invalidate()
    }
